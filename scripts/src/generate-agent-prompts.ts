...
function generatePrompt(
  ...
  if (!existsSync(templatePath)) {
    console.log(error(`✗ Template not found: ${templatePath}`));
    return false;
  }
...
async function main() {
  ...
  // Load configuration
  console.log(info(`📋 Reading configuration from: ${CONFIG_FILE}`));
  console.log();
  ...
  console.log(info('🔨 Generating prompt files:'));
  console.log();
  ...
  console.log();
  console.log(colorize('='.repeat(50), 'green'));
  console.log(success(`✓ Successfully generated ${successCount} agent prompt files`));
  console.log(colorize('='.repeat(50), 'green'));
  console.log();
